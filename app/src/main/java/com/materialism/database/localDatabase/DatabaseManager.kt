package com.materialism.database.localDatabase
...
class DatabaseManager(context: Context) {
  ...
  fun deleteUser(id: Int): Int {
    return database!!.delete(
        DatabaseHelper.TABLE_USER, "${DatabaseHelper.COLUMN_USER_ID} =?", arrayOf(id.toString()))
  }
  ...
  fun getSubcategory(id: Int): Cursor {
    ...
    return database!!.query(
        DatabaseHelper.TABLE_SUBCATEGORY,
        columns,
        "${DatabaseHelper.COLUMN_SUBCATEGORY_ID} =?",
        arrayOf(id.toString()),
        null,
