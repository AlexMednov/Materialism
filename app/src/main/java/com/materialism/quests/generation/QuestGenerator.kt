...
class QuestGenerator {
  companion object {
    ...
    fun generateDailyQuests(
      ...
      //            val totalNumber: Int = getTotalNumberOfElementsInCategory(generatedCategory,
      // itemList)
          ...
          when (category) {
            ...
            "Misc" -> itemList.Misc[randomNumber].Item
                ...
                throw IllegalArgumentException(
                    "Invalid category") // Finish this later, time to eepy sleepy
          }
      return itemGenerated
    }

    // Thats just catastrophic. JSON cant be read. Will probably redo the thing with the propper db
    // instead.
